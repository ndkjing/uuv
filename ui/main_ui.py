...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.angle_x_label = QtWidgets.QLabel(self.x_y_z_box)
        self.angle_x_label.setObjectName("angle_x_label")
        self.x_y_z_layout.addWidget(self.angle_x_label)
        self.test_paint_box = QtWidgets.QGroupBox(self.x_y_z_box)
        self.test_paint_box.setObjectName("test_paint_box")
        self.x_y_z_layout.addWidget(self.test_paint_box)
        ...
        self.speed_slider.setProperty("value", 30)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.angle_z_label.setText(_translate("MainWindow", "angle_x_label"))
        self.angle_y_label.setText(_translate("MainWindow", "angle_x_label"))
        self.angle_x_label.setText(_translate("MainWindow", "angle_x_label"))
        self.test_paint_box.setTitle(_translate("MainWindow", "GroupBox"))
        self.label.setText(_translate("MainWindow", "滑动调节条"))
